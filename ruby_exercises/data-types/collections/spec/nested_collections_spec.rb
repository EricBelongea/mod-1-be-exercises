...
RSpec.describe 'Nested Collections' do
  ...
  #  flattened_forecast = three_day_forecast.flatten
  ...
  it 'test 15' do
    ...
    # Using the three_day_forecast variable defined above,
    # retrieve the expected piece of information
    day1 = three_day_forecast[:days][0]
    day2 = three_day_forecast[:days][1]
    day3 = three_day_forecast[:days][2]

    actual = three_day_forecast[:days][1][:high]
    expected = 55
    expect(actual).to eq(expected)
    expect(day1).to eq(three_day_forecast[:days][0])
    expect(day2).to eq(three_day_forecast[:days][1])
    expect(day3).to eq(three_day_forecast[:days][2])
  end
  ...
  it 'test 16' do
    ...
    expect(actually).to eq(expected)
  end
